#!/usr/bin/env python3
"""Classify ICRA2026 papers by robot platform/embodiment."""
...
# Manual detailed classifications based on careful reading of titles and abstracts
classifications_data = {
    ...
    'pp:1965': ('ugv', ['ugv']),
    'pp:1968': ('ugv', ['ugv']),
    'pp:1980': ('marine', ['marine']),
    'pp:1981': ('soft', ['soft']),
    'pp:1982': ('multi', ['multi']),
    'pp:1983': ('uav', ['uav']),
    'pp:1991': ('multi', ['multi']),
    'pp:1992': ('arm', ['arm']),
    'pp:1993': ('medical', ['medical']),
    'pp:1994': ('multi', ['multi']),
    'pp:1998': ('car', ['car']),
    'pp:2001': ('sim', ['sim']),
    'pp:2008': ('sim', ['sim']),
    ...
    'pp:2048': ('ugv', ['ugv']),
    'pp:2051': ('arm', ['arm']),
    'pp:2058': ('wearable', ['wearable']),
    'pp:2060': ('medical', ['medical']),
    'pp:2061': ('arm', ['arm']),
    'pp:2062': ('arm', ['arm']),
    'pp:2063': ('marine', ['marine']),
    'pp:2064': ('arm', ['arm']),
    'pp:2067': ('sim', ['sim']),
    'pp:2068': ('car', ['car']),
    'pp:2069': ('ugv', ['ugv']),
...
for paper in papers:
    pid = paper['id']
    if pid in classifications_data:
        primary, topics = classifications_data[pid]
        classification[pid] = {
            'topics': topics,
            'primary': primary
        }
    else:
        # For any missing (shouldn't happen), default to sim
        classification[pid] = {
            'topics': ['sim'],
            'primary': 'sim'
        }
...
# Verify counts
assert len(classification) == len(papers), f"Mismatch: {len(classification)} vs {len(papers)}"
