...
<!--
  Install: copy this file to _pages/topics.md, assets/js/topic-graph.js, and
  assets/json/{topic_graph,topic_papers}.json into your al-folio repo.
  The widget is self-contained dark (scoped to .tm-app) so it looks the same
...
<div class="tm-app">
  ...
  <div id="tm-controls">
    <input id="tm-search" type="search" placeholder="Filter topics — SLAM, manipulation, aerial…" />
